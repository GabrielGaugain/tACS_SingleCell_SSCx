...
figname = f"linreg_{freq}Hz_Lp_PLVslope_w10Hz"
...
if savefig:
    plt.savefig(f"results/figures/reg/PLVxLp/{figname}.jpg",bbox_inches='tight', dpi=250,)
    plt.savefig(f"results/figures/reg/PLVxLp/{figname}.svg",bbox_inches='tight', dpi=250)
...
if savefig:
    plt.savefig(f"results/figures/reg/PLVxLP_natural/{figname}.jpg",bbox_inches='tight', dpi=250,)
    plt.savefig(f"results/figures/reg/PLVxLP_natural/{figname}.svg",bbox_inches='tight', dpi=250)
plt.tight_layout(pad=0)
plt.show()
...
freq = 10
lrs = pd.read_pickle(f"results/LinRegPLV_w10Hz_{freq}Hz_tACS.pkl")
# lrs = pd.read_pickle(f"results/LinRegPLV_natural_{freq}Hz_tACS.pkl")
